        ...
        public static void Main()
        {
            ...
            if (!_fullscreen && !_windowTitle.Equals(""))
            {
                try
                {
                    ...
                    Interaction.AppActivate(_windowTitle);
                    Console.WriteLine("setting " + _windowTitle + " on focus");
                }
                catch (Exception e)
                {
                    Console.WriteLine("Probably there's no window like " + _windowTitle);
                    Console.WriteLine(e.ToString());
                    Environment.Exit(9);
                }
            ...
            try
            {
                ...
                else
                {
                    ...
                    CaptureActiveWindowToFile(_file, _format);
                }
            }
            catch (Exception e)
            {
